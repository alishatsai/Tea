//
//  Menu6CollectionViewController.swift
//  TeaApp
//
...
class Menu6CollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        MenuController.shared.fetchMenuRecords(page) { (result) in
            ...
            case .failure(let error):
                self.displayError(error, title: "Failed to Fetch Menu6 Items")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as? Menu6CollectionViewCell else {return UICollectionViewCell()}
        let menuRecord = menuRecords[indexPath.item]
        cell.menu6DrinkNameLabel.text = menuRecord.fields.drinkName
        cell.menu6DrinkLargePriceLabel.text = priceIsZeroFormate(price: menuRecord.fields.largePrice!)
        cell.menu6DrinkBottlePriceLabel.text = priceIsZeroFormate(price: menuRecord.fields.bottlePrice!)
        cell.menu6ReminderLabel.text = menuRecord.fields
            .reminder
        //抓圖片
        ...
        MenuController.shared.fetchImage(urlString: imageUrl!) { result in
            ...
            case .success(let image):
                DispatchQueue.main.async {
                    cell.menu6DrinkImageView.image = image
                }
