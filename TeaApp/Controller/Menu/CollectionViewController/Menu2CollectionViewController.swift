//
//  Menu2CollectionViewController.swift
//  TeaApp
//
...
class Menu2CollectionViewController: UICollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.menu2DrinkNameLabel.text = menuRecord.fields.drinkName
        cell.menu2DrinkLargePriceLabel.text = priceIsZeroFormate(price: menuRecord.fields.largePrice!)
        cell.menu2DrinkBottlePriceLabel.text = priceIsZeroFormate(price: menuRecord.fields.bottlePrice!)
        cell.menu2ReminderLabel.text = menuRecord.fields
            .reminder
        //抓圖片
