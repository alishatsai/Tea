//
//  Menu3CollectionViewController.swift
//  TeaApp
//
...
class Menu3CollectionViewController: UICollectionViewController,UICollectionViewDelegateFlowLayout  {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.menu3DrinkNameLabel.text = menuRecord.fields.drinkName
        cell.menu3DrinkLargePriceLabel.text = priceIsZeroFormate(price: menuRecord.fields.largePrice!)
        cell.menu3DrinkBottlePriceLabel.text = priceIsZeroFormate(price: menuRecord.fields.bottlePrice!)
        cell.menu3ReminderLabel.text = menuRecord.fields
            .reminder
        //抓圖片
