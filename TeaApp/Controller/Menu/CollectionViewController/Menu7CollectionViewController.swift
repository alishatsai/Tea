//
//  Menu7CollectionViewController.swift
//  TeaApp
//
...
class Menu7CollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        MenuController.shared.fetchMenuRecords(page) { (result) in
            ...
            case .failure(let error):
                self.displayError(error, title: "Failed to Fetch Menu7 Items")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as? Menu7CollectionViewCell else {return UICollectionViewCell()}
        let menuRecord = menuRecords[indexPath.item]
        cell.menu7DrinkNameLabel.text = menuRecord.fields.drinkName
        cell.menu7DrinkLargePriceLabel.text = priceIsZeroFormate(price: menuRecord.fields.largePrice!)
        cell.menu7DrinkBottlePriceLabel.text = priceIsZeroFormate(price: menuRecord.fields.bottlePrice!)
        cell.menu7ReminderLabel.text = menuRecord.fields
            .reminder
        //抓圖片
        ...
        MenuController.shared.fetchImage(urlString: imageUrl!) { result in
            ...
            case .success(let image):
                DispatchQueue.main.async {
                    cell.menu7DrinkImageView.image = image
                }
