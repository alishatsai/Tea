//
//  Menu5CollectionViewController.swift
//  TeaApp
//
...
class Menu5CollectionViewController: UICollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.menu5DrinkNameLabel.text = menuRecord.fields.drinkName
        cell.menu5DrinkLargePriceLabel.text = priceIsZeroFormate(price: menuRecord.fields.largePrice!)
        cell.menu5DrinkBottlePriceLabel.text = priceIsZeroFormate(price: menuRecord.fields.bottlePrice!)
        cell.menu5ReminderLabel.text = menuRecord.fields
            .reminder
        //抓圖片
