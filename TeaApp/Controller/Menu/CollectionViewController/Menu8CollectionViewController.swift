//
//  Menu8CollectionViewController.swift
//  TeaApp
//
...
class Menu8CollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        MenuController.shared.fetchMenuRecords(page) { (result) in
            ...
            case .failure(let error):
                self.displayError(error, title: "Failed to Fetch Menu8 Items")
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as? Menu8CollectionViewCell else {return UICollectionViewCell()}
        let menuRecord = menuRecords[indexPath.item]
        cell.menu8DrinkNameLabel.text = menuRecord.fields.drinkName
        cell.menu8DrinkLargePriceLabel.text = priceIsZeroFormate(price: menuRecord.fields.largePrice!)
        cell.menu8DrinkBottlePriceLabel.text = priceIsZeroFormate(price: menuRecord.fields.bottlePrice!)
        cell.menu8ReminderLabel.text = menuRecord.fields
            .reminder
        //抓圖片
        ...
        MenuController.shared.fetchImage(urlString: imageUrl!) { result in
            ...
            case .success(let image):
                DispatchQueue.main.async {
                    cell.menu8DrinkImageView.image = image
                }
